...
<div class="generic">
	<div class="breadcrumbsdiv">
		<ul class="breadcrumbs">
			...
			<li><a class="last" href="">Management Users</a></li>
		</ul>
	</div>
	<br />
	...
	<spring:url var="action" value='/admin/user/delete' />
	<form:form id="form-delete" method="post" action="${action}"
		...
		<ul class="nav nav-tabs">
			...
			<li><a href="user/insertUser"><img align="absmiddle"
		...
		<table id="result" class="table table-condensed">
			...
			<c:forEach var="user" items="${users}">
				...
				<tr class="warning">
					...
					<td>${user.typeUser}</td>
					<td><a
						href="<c:url value="/admin/user/editUser?id=${user.id}" />"
