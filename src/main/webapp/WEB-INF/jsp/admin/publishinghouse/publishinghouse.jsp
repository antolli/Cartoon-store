...
<div class="generic">
	<div class="breadcrumbsdiv">
		<ul class="breadcrumbs">
			...
			<li><a class="last" href="">Management Publishing Houses</a></li>
		</ul>
	</div>
	<br />
	...
	<spring:url var="action" value='/admin/publishinghouse/delete' />
	<form:form id="form-delete" method="post" action="${action}"
		...
		<ul class="nav nav-tabs">
			...
			<li><a href="publishinghouse/insertPublishingHouse"><img align="absmiddle"
		...
		<table id="result" class="table table-condensed">
			...
			<c:forEach var="publishinghouse" items="${publishinghouses}">
				...
				%>
				<tr class="warning">
					<td><input type="checkbox" name="id" value="${publishinghouse.id}" /></td>
					<td>${publishinghouse.id}</td>
					<td>${publishinghouse.name}</td>
					<td><a
						href="<c:url value="/admin/publishinghouse/editPublishingHouse?id=${publishinghouse.id}" />"
