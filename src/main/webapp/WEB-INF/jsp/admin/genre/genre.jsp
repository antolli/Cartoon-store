...
<div class="generic">
	<div class="breadcrumbsdiv">
		<ul class="breadcrumbs">
			...
			<li><a class="last" href="">Management Genres</a></li>
		</ul>
	</div>
	<br />
	...
	<spring:url var="action" value='/admin/genre/delete' />
	<form:form id="form-delete" method="post" action="${action}"
		...
		<ul class="nav nav-tabs">
			...
			<li><a href="genre/insertGenre"><img align="absmiddle"
		...
		<table id="result" class="table table-condensed">
			...
			<c:forEach var="genre" items="${genres}">
				...
				%>
				<tr class="warning">
					<td><input type="checkbox" name="id" value="${genre.id}" /></td>
					<td>${genre.id}</td>
					<td>${genre.name}</td>
					<td><a
						href="<c:url value="/admin/genre/editGenre?id=${genre.id}" />"
